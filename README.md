...
- `"…"` strings may span several physical lines (a literal newline is kept in the token), like Clojure and unlike Go's `text/scanner`; an unterminated string is therefore only reported at EOF
